...
Your submission from Friday is your goal – go for it, ask lots of questions, and
in the following week we'll all be working on merging, doing some interface
updates where we weren't able to avoid conflicts for good reason, and planning
out the next set of tests to pass. To give a sense:
